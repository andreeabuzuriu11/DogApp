...
import com.buzuriu.dogapp.adapters.EditCountryAdapter
...
class EditCountryViewModel : BaseViewModel() {

    var selectedCountry: CountryObj? = null
    var locationObj: LocationObj? = null
    var countryAdapter: EditCountryAdapter? = null
    ...
    init {
        ...
        countryAdapter = EditCountryAdapter(countriesList, this)
    }
